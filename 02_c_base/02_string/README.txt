...
- Реализации функций должны быть идентичны библиотечным. Есть резон покрыть юнит-тестами, для этого можно использовать
  библиотеку check.h
  В интернете легко гуглится способ использования этой библиотеки вместе с примерами кода - ориентироваться на них.
  ...
  Тесты, естественно, вместе с библиотекой реализовывать не надо - пускай это будет отдельный код,
  который подключает библиотеку и чекает её.
